...
if (materialSaveButton) {
  ...
  const teqCategoryInput = document.getElementById("teqCategory"); //教材の技術カテゴリ
  ...
  const registerMaterial = () => {
    ...
    const teqCategory = teqCategoryInput.value;

    if (materialName /*&& materialImage*/ && teqCategory) {
      // // 教材リストに追加
      ...
      // teqCategoryInput.value = "";
    } else {
      alert("教材名とカテゴリはすべて入力してください。");
    }
  }
